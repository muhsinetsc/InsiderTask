...
class TestInsider:
    ...
    def test_insider(self):
        ...
        assert "Quality Assurance" in (position := base.wait_for_element_to_be_visible(POSITION).text), f"Expected 'Quality Assurance' to be in the text, but found: {position}"
