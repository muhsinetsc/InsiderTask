...
ISTANBUL_TURKEY_TITLE = (By.CSS_SELECTOR,"#select2-filter-by-location-container")
HOVER_JOB = (By.CSS_SELECTOR,"")
LOCATION = (By.CSS_SELECTOR,"#jobs-list > div > div > div")
POSITION = (By.CSS_SELECTOR,"//*[@id='jobs-list']/div/div/p")
DEPARTMENT = (By.CSS_SELECTOR,"#jobs-list > div > div > span")
ALL_CAPTION = (By.ID,"select2-filter-by-location-container")
